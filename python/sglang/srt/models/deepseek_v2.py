...
class DeepseekV2MoE(nn.Module):
    ...
    def forward_deepep(
        ...
        self._forward_deepep_dispatch_a(
            self.deepep_dispatcher, forward_mode, hidden_states, router_logits,forward_batch.num_token_non_padded
        )
        (
            hidden_states,
            topk_idx,
    ...
    def _forward_deepep_dispatch_a(
        self, chosen_deepep_dispatcher, forward_mode, hidden_states, router_logits,num_token_non_padded
    ):
        if (
            forward_mode is not None
            and not forward_mode.is_idle()
