...
class DecodePreallocQueue:
    ...
    def _init_kv_manager(self) -> CommonKVManager:
        ...
        # NPU-only: see prefill.py:_init_kv_manager for the full rationale.
        # GPU pools leave this field unset (slicing falls back to legacy
        # layer-stripe behavior, bit-exact identical to before).
