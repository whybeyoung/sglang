...
use crate::protocols::common::{Tool, ToolChoice, ToolChoiceValue, ToolCallDelta, FunctionCallDelta, Usage, StringOrArray};
...
static PARSER_FACTORY: Lazy<crate::tool_parser::ParserFactory> = Lazy::new(|| crate::tool_parser::ParserFactory::new());
