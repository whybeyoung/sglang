...
#[allow(dead_code)]
pub fn proto_response_to_json(response: &crate::grpc_client::proto::GenerateResponse) -> String {
    ...
    match &response.response {
        Some(crate::grpc_client::proto::generate_response::Response::Chunk(chunk)) => {
        ...
        Some(crate::grpc_client::proto::generate_response::Response::Complete(complete)) => {
        ...
        Some(crate::grpc_client::proto::generate_response::Response::Error(err)) => {
